...
(function() {
  var View, XHR, ajax, app, cacheFrames, currentTestId, deepCopy, defaultModel, elemAddEventListener, expect, express, extend, handleInteraction, incrementalLoad, legacy, log, port, startTime, syncLog, t0, testDone, testModel, testView, testcount,
    __slice = [].slice;
  ...
  if (!isNodeJs) {
    ...
    handleInteraction = function(model, view) {
      ...
      return elemAddEventListener(document, "touchmove", function(e) {
