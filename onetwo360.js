...
(function() {
  var View, XHR, ajax, app, cacheFrames, currentTestId, deepCopy, defaultModel, expect, express, extend, incrementalLoad, lastUpdateTime, legacy, log, port, t0, testModel, testView, testcount;
