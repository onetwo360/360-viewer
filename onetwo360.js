...
(function() {
  var View, XHR, ajax, app, cacheFrames, currentTestId, deepCopy, defaultModel, expect, express, extend, incrementalLoad, legacy, port, testModel, testView, testcount;
  ...
  if (!isNodeJs) {
    ...
    incrementalLoad = function(model, view, cb) {
      ...
      incrementalUpdate = function() {
        var count, loadTime, maxTime, now;
        count = 0;
        maxTime = loadStart;
