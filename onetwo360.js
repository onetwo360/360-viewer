...
(function() {
  var View, XHR, ajax, app, cacheFrames, currentTestId, deepCopy, defaultModel, expect, express, extend, incrementalLoad, lastUpdateTime, legacy, port, t0, testModel, testView, testcount;
  ...
  if (!isNodeJs) {
    ...
    if (runTest) {
      ...
      testView = void 0;
      (function() {
        var frames, i, t0, t1, _i, _j, _len, _ref;
        _ref = [testModel.frames.normal, testModel.frames.zoom];
    ...
    incrementalLoad = function(model, view, cb) {
      ...
      if (model.spinOnLoadFPS) {
        cacheFrames(model.frames.normal, function() {
          return console.log("loaded " + (+new Date() - t0));
        });
    ...
    if (runTest) {
      incrementalLoad(testModel, testView, function() {
        return console.log("spinned " + (+new Date() - t0));
      });
    }
